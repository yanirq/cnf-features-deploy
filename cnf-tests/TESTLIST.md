...
| [performance] CPU Management Hyper-thread aware scheduling for guaranteed pods Verify Hyper-Thread aware scheduling for guaranteed pods  HT aware scheduling on SNO cluster | Verifies HT aware scheduling works on SNO cluster | 
| [performance] CPU Management Hyper-thread aware scheduling for guaranteed pods Verify Hyper-Thread aware scheduling for guaranteed pods  HT aware scheduling on SNO cluster and Workload Partitioning enabled | Verifies HT aware scheduling works on SNO cluster and Workload Partitioning enabled | 
| [performance] CPU Management Hyper-thread aware scheduling for guaranteed pods Verify Hyper-Thread aware scheduling for guaranteed pods  Number of CPU requests as multiple of SMT count allowed when HT enabled | Verifies that number of CPU requests as multiple of SMT count are allowed when HT enabled | 
| [performance] CPU Management Hyper-thread aware scheduling for guaranteed pods Verify Hyper-Thread aware scheduling for guaranteed pods  Odd number of CPU requests allowed when HT disabled | Verifies that odd number of CPU requests is allowed when HT disabled | 
